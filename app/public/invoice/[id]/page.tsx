...
export default function PublicInvoiceView() {
    ...
    console.log("Public Invoice Link");
    ...
    const fetchInvoice = async () => {
        ...
        try {
            ...
            console.log("Public Invoice Data: ", response);
                ...
                <div ref={printRef} className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 print-break-inside-avoid">
                        ...
                        <div className="text-right">
                            <h2 className="text-xl font-bold">Invoice #{invoice.invoice.id}</h2>
                    ...
                    {/* Dates */}
                    <div className="flex justify-between text-sm print-break-inside-avoid">
                        <div>
                            <p>
                                <span className="font-medium">Invoice Date:</span> {new Date(invoice.invoice.date).toLocaleDateString()}
                            </p>
                        </div>
                        <div>
                            <p>
                                <span className="font-medium">Due Date:</span> {new Date(invoice.invoice.dueDate).toLocaleDateString()}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 print-break-inside-avoid">
                        ...
                        <Card className="print-card">
                            <CardContent className="p-4">
                                ...
                                <div className="space-y-1">
                                    <p>
                                        <span className="font-medium">Vehicle:</span> {invoice.vehicle.make} | {invoice.vehicle.model} | {invoice.vehicle.year}
                                    </p>
                                    <p>
                                        <span className="font-medium">Vehicle ID:</span> {invoice.vehicleId}
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                    ...
                    <Card className="print-card print-break-inside-avoid">
                        <CardContent className="p-4">
                            <h3 className="font-bold text-lg mb-3">Services & Charges</h3>
                    ...
                    {invoice.invoice.notes && (
                        <Card className="print-card print-break-inside-avoid">
                            <CardContent className="p-4">
                                ...
                                <p className="text-gray-700">{invoice.invoice.notes}</p>
                            </CardContent>
                        </Card>
                    )}

                    {/* Footer */}
                    <div className="text-center text-sm text-gray-500 mt-8 print-break-inside-avoid">
